...
Template.registerNetwork.events({
  'submit .register-form1': function (event) {
    ...
    privatContent:$('#privatContent').is(":checked"),dmxLight:$('#dmxLight').is(":checked"),logUpdateTime:$('#logUpdateTime').val(),
     sortiment: sortiment, region: region,logo: result,image: resultH ,news: news, headline: headline,
     headline2: headline2,headline3: headline3,footer1:footer1,footer2:footer2,footer3:footer3,footer4:footer4});
